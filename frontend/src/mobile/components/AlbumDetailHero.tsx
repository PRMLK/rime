import type { AlbumDetail } from '@/mobile/api/rime';
import { AlbumArtworkSkeleton } from '@/mobile/components/AlbumArtwork';
import { AlbumDetailHeroInfo } from '@/mobile/components/AlbumDetailHeroInfo';
import { AlbumVinylArtwork } from '@/mobile/components/AlbumVinylArtwork';
