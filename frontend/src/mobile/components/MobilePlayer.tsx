...
import { getAccountSettings, getFavoriteStatus, searchTracks, setFavorite, type ArtistRef, type Track, type User } from '@/mobile/api/rime';
import { AlbumArtwork } from '@/mobile/components/AlbumArtwork';
import { AppScrollArea } from '@/mobile/components/AppScrollArea';
import { ClientSettingsDrawer } from '@/mobile/components/ClientSettingsDrawer';
import { LibraryView } from '@/mobile/components/LibraryView';
import { AlbumDetailView } from '@/mobile/components/views/album-detail-view';
import { ArtistDetailView } from '@/mobile/components/views/artist-detail-view';
import { AllAlbumsView, HomeView, RecentAlbumsView } from '@/mobile/components/views/home-view';
import { NowPlayingDrawer } from '@/mobile/components/views/now-playing-drawer';
import { SearchView } from '@/mobile/components/views/search-view';
import { SystemSettingsDrawer } from '@/mobile/components/views/system-settings-drawer';
...
} from '@/mobile/lib/artwork-color';
import { cn } from '@/lib/utils';
import { clientSettingsScope } from '@/mobile/lib/client-settings';
import type { SavedServer } from '@/mobile/lib/mobile-server';
import { formatMobileRoute, useMobileRoute } from '@/shared/mobile-route';
import { useAlbumArtworkAccentColor } from '@/mobile/hooks/use-album-artwork-accent-color';
import { useInfiniteCursorList } from '@/mobile/hooks/use-infinite-cursor-list';
import { HtmlAudioPlayer } from '@/mobile/services/player/HtmlAudioPlayer';
