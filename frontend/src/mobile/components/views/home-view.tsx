...
import { favoriteAlbumsChangedEvent, getAlbums, getFavoriteAlbums, getPlaylist, getPlaylists, getRecentAlbums, getRecentPlaybackTracks, playbackHistoryChangedEvent, playlistsChangedEvent, type AlbumPage, type Track } from '@/mobile/api/rime';
...
import { AlbumCard, AlbumGrid, DetailEmpty, type AlbumCardAlbum } from '@/mobile/components/views/album-collection';
