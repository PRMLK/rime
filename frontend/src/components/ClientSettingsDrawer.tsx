      ...
      <DrawerContent className="h-[calc(100dvh-0.5rem)] max-h-[calc(100dvh-0.5rem)]">
        <div className="mobile-content-frame">
          <DrawerHeader className="flex-row items-center gap-2 p-0 pb-2 pt-3 text-left">
            <DrawerClose render={<Button variant="ghost" size="icon" aria-label="退出客户端设置"><ChevronDown aria-hidden="true" /></Button>} />
            <DrawerTitle className="min-w-0 flex-1 text-center text-sm">客户端设置</DrawerTitle>
            <span className="size-8 shrink-0" aria-hidden="true" />
          </DrawerHeader>
        </div>
        <AppScrollArea className="min-h-0 flex-1">
          <section className="mobile-content-frame flex flex-col gap-8 pb-[max(env(safe-area-inset-bottom),1.5rem)]" aria-label="客户端设置项目">
            <FieldGroup>
